...
It seems that bicycle use decresed as the winter months approached, and then arrived. This may be attributed to worsening weather conditions. 
...
Trips %>% 
  ...
  left_join(Stations,
            by = "name") %>% 
  ggplot(aes(x = lat, y = long, color = name)) +
  geom_point() +

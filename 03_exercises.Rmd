...
I began by simply summarizing the original "garden_harvest" data set to calculate the total harvest in lbs for each vegetable variety. I renamed this garden_harvest2. I then selected only the essential columns from the garden_planting data set and named it "selected_garden_planting", I then did a full join to by vegetable and variety to add plot to the original garden_harvest2. Problems may arise if varieties were planted in multiple plots.
